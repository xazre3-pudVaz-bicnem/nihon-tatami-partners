...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      "@type": "Question",
      name: "掲載業者は審査されていますか？",
      acceptedAnswer: { "@type": "Answer", text: "はい。掲載前に資格・保険・実績を確認しています。一級畳製作技能士や損害賠償保険の加入状況は各業者のプロフィールでご確認いただけます。" },
    },
    {
      "@type": "Question",
    ...
    <>
      ...
      <FAQSection
        items={[
          ...
          { question: "掲載業者は審査されていますか？", answer: "はい。掲載前に資格・保険・実績を確認しています。一級畳製作技能士や損害賠償保険の加入状況は各業者のプロフィールでご確認いただけます。" },
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
          {[
            ...
            { title: "審査不要で即掲載", description: "申請フォーム入力後、審査が通れば最短翌日から掲載開始。" },
